...
class MenuSelectDatePlayback extends StatefulWidget {
  const MenuSelectDatePlayback({super.key, this.isMultiPlayback});
  final bool? isMultiPlayback;

  @override
  State<MenuSelectDatePlayback> createState() => _MenuSelectDatePlaybackState();
}

class _MenuSelectDatePlaybackState extends State<MenuSelectDatePlayback> {
  ...
  MultiPlaybackBloc get bloc => context.read<MultiPlaybackBloc>();
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: MenuAnchor(
        ...
        useRootOverlay: true,
        child: BlocSelector<MultiPlaybackBloc, MultiPlaybackState, DateTime>(

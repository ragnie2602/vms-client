...
class _ControlCameraScreenState extends State<ControlCameraScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<ControlCameraBloc, ControlCameraState>(
      listenWhen: (prev, curr) => curr is DeleteCameraSuccessState || curr is ListCameraSuccessState,
      listener: (context, state) {
        if (state is DeleteCameraSuccessState) {
          _onGetListCamera();
          showAppMessageDialog(context, message: 'Xóa camera thành công!', type: AppMessageType.success);
                      ...
                      return Flexible(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) => ItemCameraWidget(
                            ...
                            onDelete: () => _onDeleteCamera(cameraId: cameras[index].id),
                          ),
                        ),
                      );
                    },

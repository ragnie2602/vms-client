...
abstract class $AuthenticationCopyWith<$Res> {
  factory $AuthenticationCopyWith(
    ...
    $Res Function(Authentication) then,
  ) = _$AuthenticationCopyWithImpl<$Res, Authentication>;
  @useResult
  $Res call({String account, List<int> sessionId, List<int> uid, String ssid});
}
...
abstract class _$$AuthenticationImplCopyWith<$Res>
    implements $AuthenticationCopyWith<$Res> {
  factory _$$AuthenticationImplCopyWith(
    _$AuthenticationImpl value,
...
class __$$AuthenticationImplCopyWithImpl<$Res>
  ...
  __$$AuthenticationImplCopyWithImpl(
    _$AuthenticationImpl _value,
    $Res Function(_$AuthenticationImpl) _then,
  ) : super(_value, _then);
...
class _$AuthenticationImpl implements _Authentication {
  ...
  @override
  String toString() {
    return 'Authentication(account: $account, sessionId: $sessionId, uid: $uid, ssid: $ssid)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$AuthenticationImplToJson(this);
  }
}

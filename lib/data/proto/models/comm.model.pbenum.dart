...
class EventType extends $pb.ProtobufEnum {
  ...
  static const EventType LINE_CROSSING =
      EventType._(1, _omitEnumNames ? '' : 'LINE_CROSSING');
  ...
  static const EventType IVA_ALPR =
      EventType._(5, _omitEnumNames ? '' : 'IVA_ALPR');
  static const EventType ALL_TYPE =
      EventType._(98, _omitEnumNames ? '' : 'ALL_TYPE');
...
class Quality extends $pb.ProtobufEnum {
  ...
  static final $core.List<Quality?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 3);
  static Quality? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const Quality._(super.value, super.name);
}

class ProjectTarget extends $pb.ProtobufEnum {
  static const ProjectTarget VIVAS =
      ProjectTarget._(0, _omitEnumNames ? '' : 'VIVAS');
  static const ProjectTarget VIVAS_CLOUD =
      ProjectTarget._(1, _omitEnumNames ? '' : 'VIVAS_CLOUD');
  static const ProjectTarget KC01 =
      ProjectTarget._(99, _omitEnumNames ? '' : 'KC01');
  ...
  static final $core.Map<$core.int, ProjectTarget> _byValue =
      $pb.ProtobufEnum.initByValue(values);
  static ProjectTarget? valueOf($core.int value) => _byValue[value];

  const ProjectTarget._(super.value, super.name);
}

class Box_Type extends $pb.ProtobufEnum {
  static const Box_Type NONE = Box_Type._(0, _omitEnumNames ? '' : 'NONE');
  static const Box_Type RASPBERRY =
      Box_Type._(1, _omitEnumNames ? '' : 'RASPBERRY');
  static const Box_Type ORANGEPI =
      Box_Type._(2, _omitEnumNames ? '' : 'ORANGEPI');
  ...
  static final $core.List<Box_Type?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static Box_Type? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const Box_Type._(super.value, super.name);
}

class Box_State extends $pb.ProtobufEnum {
  static const Box_State VBOX_ACTIVE =
      Box_State._(0, _omitEnumNames ? '' : 'VBOX_ACTIVE');
  static const Box_State VBOX_INACTIVE =
      Box_State._(1, _omitEnumNames ? '' : 'VBOX_INACTIVE');
  static const Box_State VBOX_LOST =
      Box_State._(2, _omitEnumNames ? '' : 'VBOX_LOST');
  ...
  static final $core.List<Box_State?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static Box_State? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const Box_State._(super.value, super.name);
}

class Language extends $pb.ProtobufEnum {
  static const Language DEFAULT =
      Language._(0, _omitEnumNames ? '' : 'DEFAULT');
...
class CameraType extends $pb.ProtobufEnum {
  static const CameraType UNKNOW =
      CameraType._(0, _omitEnumNames ? '' : 'UNKNOW');
  static const CameraType RTSP = CameraType._(1, _omitEnumNames ? '' : 'RTSP');
  static const CameraType ONVIF =
      CameraType._(2, _omitEnumNames ? '' : 'ONVIF');
  static const CameraType ONEHOME_VNT =
      CameraType._(3, _omitEnumNames ? '' : 'ONEHOME_VNT');
  ...
  static final $core.List<CameraType?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 4);
  static CameraType? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const CameraType._(super.value, super.name);
}

class PtzAction extends $pb.ProtobufEnum {
  static const PtzAction PTZ_STOP =
      PtzAction._(0, _omitEnumNames ? '' : 'PTZ_STOP');
  static const PtzAction PTZ_UP =
      PtzAction._(1, _omitEnumNames ? '' : 'PTZ_UP');
  static const PtzAction PTZ_DOWN =
      PtzAction._(2, _omitEnumNames ? '' : 'PTZ_DOWN');
  static const PtzAction PTZ_LEFT =
      PtzAction._(3, _omitEnumNames ? '' : 'PTZ_LEFT');
  static const PtzAction PTZ_RIGHT =
      PtzAction._(6, _omitEnumNames ? '' : 'PTZ_RIGHT');
  ...
  static final $core.List<PtzAction?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 6);
  static PtzAction? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const PtzAction._(super.value, super.name);
}

class API extends $pb.ProtobufEnum {
  static const API UNDEFINED = API._(0, _omitEnumNames ? '' : 'UNDEFINED');
  static const API API_VERSION =
      API._(111, _omitEnumNames ? '' : 'API_VERSION');
  ...
  static final $core.Map<$core.int, API> _byValue =
      $pb.ProtobufEnum.initByValue(values);
  static API? valueOf($core.int value) => _byValue[value];

  const API._(super.value, super.name);
}

class NetworkType extends $pb.ProtobufEnum {
  static const NetworkType DHCP =
      NetworkType._(0, _omitEnumNames ? '' : 'DHCP');
  static const NetworkType STATIC =
      NetworkType._(1, _omitEnumNames ? '' : 'STATIC');
...
class Vehicle_Type extends $pb.ProtobufEnum {
  static const Vehicle_Type CAR =
      Vehicle_Type._(0, _omitEnumNames ? '' : 'CAR');
  static const Vehicle_Type MOTOBIKE =
      Vehicle_Type._(1, _omitEnumNames ? '' : 'MOTOBIKE');
  static const Vehicle_Type TRUCK =
      Vehicle_Type._(2, _omitEnumNames ? '' : 'TRUCK');
  ...
  static final $core.List<Vehicle_Type?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static Vehicle_Type? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const Vehicle_Type._(super.value, super.name);
}
...
class Base_View extends $pb.ProtobufEnum {
  ...
  static final $core.List<Base_View?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 5);
  static Base_View? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const Base_View._(super.value, super.name);
}
...
class Session_Platform extends $pb.ProtobufEnum {
  ...
  static const Session_Platform IOS_ =
      Session_Platform._(1, _omitEnumNames ? '' : 'IOS_');
  static const Session_Platform ANDROID_ =
      Session_Platform._(2, _omitEnumNames ? '' : 'ANDROID_');
  static const Session_Platform WINPHONE_ =
      Session_Platform._(3, _omitEnumNames ? '' : 'WINPHONE_');
  static const Session_Platform MACX_ =
      Session_Platform._(4, _omitEnumNames ? '' : 'MACX_');
  static const Session_Platform WINDOWS_ =
      Session_Platform._(5, _omitEnumNames ? '' : 'WINDOWS_');
  static const Session_Platform LINUX_ =
      Session_Platform._(6, _omitEnumNames ? '' : 'LINUX_');
  static const Session_Platform WEB_SOCK_ =
      Session_Platform._(7, _omitEnumNames ? '' : 'WEB_SOCK_');
  static const Session_Platform VBOX_ =
      Session_Platform._(8, _omitEnumNames ? '' : '_VBOX');
  static const Session_Platform OTHER_ =
      Session_Platform._(99, _omitEnumNames ? '' : 'OTHER_');
  ...
  const Session_Platform._(super.value, super.name);
}

class Profile_Type extends $pb.ProtobufEnum {
  static const Profile_Type USER =
      Profile_Type._(0, _omitEnumNames ? '' : 'USER');
  static const Profile_Type ADMIN =
      Profile_Type._(1, _omitEnumNames ? '' : 'ADMIN');
  static const Profile_Type SUPER_ADMIN =
      Profile_Type._(2, _omitEnumNames ? '' : 'SUPER_ADMIN');
  static const Profile_Type SYS_ADMIN =
      Profile_Type._(3, _omitEnumNames ? '' : 'SYS_ADMIN');
  static const Profile_Type AGENT =
      Profile_Type._(4, _omitEnumNames ? '' : 'AGENT');
  static const Profile_Type ADMIN_CLIENT =
      Profile_Type._(5, _omitEnumNames ? '' : 'ADMIN_CLIENT');
  ...
  static final $core.List<Profile_Type?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 5);
  static Profile_Type? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const Profile_Type._(super.value, super.name);
}

class BoxInfo_Box_Type extends $pb.ProtobufEnum {
  static const BoxInfo_Box_Type NONE =
      BoxInfo_Box_Type._(0, _omitEnumNames ? '' : 'NONE');
  static const BoxInfo_Box_Type RASPBERRY =
      BoxInfo_Box_Type._(1, _omitEnumNames ? '' : 'RASPBERRY');
  static const BoxInfo_Box_Type ORANGEPI =
      BoxInfo_Box_Type._(2, _omitEnumNames ? '' : 'ORANGEPI');
  ...
  static final $core.List<BoxInfo_Box_Type?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static BoxInfo_Box_Type? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const BoxInfo_Box_Type._(super.value, super.name);
}

class ScheduleTime_Day extends $pb.ProtobufEnum {
  static const ScheduleTime_Day CN =
      ScheduleTime_Day._(0, _omitEnumNames ? '' : 'CN');
  static const ScheduleTime_Day T2 =
      ScheduleTime_Day._(1, _omitEnumNames ? '' : 'T2');
  static const ScheduleTime_Day T3 =
      ScheduleTime_Day._(2, _omitEnumNames ? '' : 'T3');
  static const ScheduleTime_Day T4 =
      ScheduleTime_Day._(3, _omitEnumNames ? '' : 'T4');
  static const ScheduleTime_Day T5 =
      ScheduleTime_Day._(4, _omitEnumNames ? '' : 'T5');
  static const ScheduleTime_Day T6 =
      ScheduleTime_Day._(5, _omitEnumNames ? '' : 'T6');
  static const ScheduleTime_Day T7 =
      ScheduleTime_Day._(6, _omitEnumNames ? '' : 'T7');
  ...
  static final $core.List<ScheduleTime_Day?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 6);
  static ScheduleTime_Day? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const ScheduleTime_Day._(super.value, super.name);
}
...
class Recording_TypeSchedule extends $pb.ProtobufEnum {
  ...
  static const $core.List<Recording_TypeSchedule> values =
      <Recording_TypeSchedule>[
    ALWAY_RECORDING,
    CUSTOMIZE_RECORDING,
  ];
  ...
  const Recording_TypeSchedule._(super.value, super.name);
}
...
class Recording_RecordingForm extends $pb.ProtobufEnum {
  ...
  static const $core.List<Recording_RecordingForm> values =
      <Recording_RecordingForm>[
    CLOUD,
    SD_CARD,
    ALL,
  ];

  static final $core.List<Recording_RecordingForm?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static Recording_RecordingForm? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const Recording_RecordingForm._(super.value, super.name);
}
...
class IVAJobRegionMotionDetect_Level extends $pb.ProtobufEnum {
  ...
  static const $core.List<IVAJobRegionMotionDetect_Level> values =
      <IVAJobRegionMotionDetect_Level>[
    LOW,
    MEDIUM,
    HIGH,
  ];

  static final $core.List<IVAJobRegionMotionDetect_Level?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static IVAJobRegionMotionDetect_Level? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const IVAJobRegionMotionDetect_Level._(super.value, super.name);
}
...
class IVA_JobLineCrossing_Detect_DirectionType extends $pb.ProtobufEnum {
  static const IVA_JobLineCrossing_Detect_DirectionType A__B =
      IVA_JobLineCrossing_Detect_DirectionType._(
          0, _omitEnumNames ? '' : 'A__B');
  static const IVA_JobLineCrossing_Detect_DirectionType B__A =
      IVA_JobLineCrossing_Detect_DirectionType._(
          1, _omitEnumNames ? '' : 'B__A');
  ...
  static final $core.List<IVA_JobLineCrossing_Detect_DirectionType?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static IVA_JobLineCrossing_Detect_DirectionType? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const IVA_JobLineCrossing_Detect_DirectionType._(super.value, super.name);
}
...
class IVA_JobLineCrossing_Detect_Level extends $pb.ProtobufEnum {
  ...
  static final $core.List<IVA_JobLineCrossing_Detect_Level?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static IVA_JobLineCrossing_Detect_Level? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const IVA_JobLineCrossing_Detect_Level._(super.value, super.name);
}
...
class IVA_IntrusionDetection_Detect_Level extends $pb.ProtobufEnum {
  ...
  static final $core.List<IVA_IntrusionDetection_Detect_Level?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static IVA_IntrusionDetection_Detect_Level? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const IVA_IntrusionDetection_Detect_Level._(super.value, super.name);
}
...
class IVA_Smoke_Detect_Level extends $pb.ProtobufEnum {
  ...
  static const $core.List<IVA_Smoke_Detect_Level> values =
      <IVA_Smoke_Detect_Level>[
    LOW,
    MEDIUM,
    HIGH,
  ];

  static final $core.List<IVA_Smoke_Detect_Level?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static IVA_Smoke_Detect_Level? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const IVA_Smoke_Detect_Level._(super.value, super.name);
}
...
class CameraConfig_Rotate extends $pb.ProtobufEnum {
  ...
  static const CameraConfig_Rotate RIGHT =
      CameraConfig_Rotate._(1, _omitEnumNames ? '' : 'RIGHT');
  static const CameraConfig_Rotate LEFT =
      CameraConfig_Rotate._(2, _omitEnumNames ? '' : 'LEFT');
  ...
  static final $core.List<CameraConfig_Rotate?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static CameraConfig_Rotate? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const CameraConfig_Rotate._(super.value, super.name);
}
...
class CameraConfig_StorageMode extends $pb.ProtobufEnum {
  ...
  static const $core.List<CameraConfig_StorageMode> values =
      <CameraConfig_StorageMode>[
    CLOUD,
    CLOUD_AND_SDCARD,
  ];

  static final $core.List<CameraConfig_StorageMode?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 1);
  static CameraConfig_StorageMode? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const CameraConfig_StorageMode._(super.value, super.name);
}

class CameraConfig_Level extends $pb.ProtobufEnum {
  static const CameraConfig_Level LOW =
      CameraConfig_Level._(0, _omitEnumNames ? '' : 'LOW');
  static const CameraConfig_Level MEDIUM =
      CameraConfig_Level._(1, _omitEnumNames ? '' : 'MEDIUM');
  static const CameraConfig_Level HIGH =
      CameraConfig_Level._(2, _omitEnumNames ? '' : 'HIGH');
  ...
  static final $core.List<CameraConfig_Level?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static CameraConfig_Level? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const CameraConfig_Level._(super.value, super.name);
}
...
class CameraStream_DefaultURL extends $pb.ProtobufEnum {
  ...
  static const $core.List<CameraStream_DefaultURL> values =
      <CameraStream_DefaultURL>[
    HLS,
    RTSP_ORIGIN,
    RTSP_PROXY,
    RTMP,
  ...
  static final $core.List<CameraStream_DefaultURL?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 3);
  static CameraStream_DefaultURL? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const CameraStream_DefaultURL._(super.value, super.name);
}
...
class CameraStream_UrlStream_StreamType extends $pb.ProtobufEnum {
  ...
  static const CameraStream_UrlStream_StreamType RTSP_PROXY =
      CameraStream_UrlStream_StreamType._(
          3, _omitEnumNames ? '' : 'RTSP_PROXY');
  ...
  static final $core.List<CameraStream_UrlStream_StreamType?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 4);
  static CameraStream_UrlStream_StreamType? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const CameraStream_UrlStream_StreamType._(super.value, super.name);
}

class Camera_Type extends $pb.ProtobufEnum {
  static const Camera_Type OWNER =
      Camera_Type._(0, _omitEnumNames ? '' : 'OWNER');
  static const Camera_Type SHARED =
      Camera_Type._(1, _omitEnumNames ? '' : 'SHARED');
  static const Camera_Type GROUP_SHARED =
      Camera_Type._(2, _omitEnumNames ? '' : 'GROUP_SHARED');
  ...
  static final $core.List<Camera_Type?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static Camera_Type? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const Camera_Type._(super.value, super.name);
}

class Camera_Role extends $pb.ProtobufEnum {
  static const Camera_Role VIEW =
      Camera_Role._(0, _omitEnumNames ? '' : 'VIEW');
  ...
  static final $core.List<Camera_Role?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 1);
  static Camera_Role? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const Camera_Role._(super.value, super.name);
}

class Camera_Status extends $pb.ProtobufEnum {
  static const Camera_Status INACTIVE =
      Camera_Status._(0, _omitEnumNames ? '' : 'INACTIVE');
  static const Camera_Status ACTIVE =
      Camera_Status._(1, _omitEnumNames ? '' : 'ACTIVE');
  ...
  static final $core.List<Camera_Status?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 1);
  static Camera_Status? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const Camera_Status._(super.value, super.name);
}
...
class Alarm_Type extends $pb.ProtobufEnum {
  ...
  static final $core.List<Alarm_Type?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 1);
  static Alarm_Type? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const Alarm_Type._(super.value, super.name);
}
...
class Alarm_Storage extends $pb.ProtobufEnum {
  ...
  static const Alarm_Storage SD_CARD =
      Alarm_Storage._(1, _omitEnumNames ? '' : 'SD_CARD');
  ...
  static final $core.List<Alarm_Storage?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 1);
  static Alarm_Storage? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const Alarm_Storage._(super.value, super.name);
}
...
class FaceDetection_DetectionType extends $pb.ProtobufEnum {
  ...
  static const FaceDetection_DetectionType UNKNOWN_DETECTION =
      FaceDetection_DetectionType._(
          1, _omitEnumNames ? '' : 'UNKNOWN_DETECTION');

  static const $core.List<FaceDetection_DetectionType> values =
      <FaceDetection_DetectionType>[
    FACE_DETECTION,
    UNKNOWN_DETECTION,
  ];

  static final $core.List<FaceDetection_DetectionType?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 1);
  static FaceDetection_DetectionType? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const FaceDetection_DetectionType._(super.value, super.name);
}
...
class DeviceGroup_Status extends $pb.ProtobufEnum {
  ...
  static const DeviceGroup_Status ACTIVE =
      DeviceGroup_Status._(1, _omitEnumNames ? '' : 'ACTIVE');
  ...
  static final $core.List<DeviceGroup_Status?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 1);
  static DeviceGroup_Status? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const DeviceGroup_Status._(super.value, super.name);
}

class DeviceGroup_Type extends $pb.ProtobufEnum {
  static const DeviceGroup_Type OWNER =
      DeviceGroup_Type._(0, _omitEnumNames ? '' : 'OWNER');
  static const DeviceGroup_Type SHARED =
      DeviceGroup_Type._(1, _omitEnumNames ? '' : 'SHARED');
  static const DeviceGroup_Type MOVED =
      DeviceGroup_Type._(2, _omitEnumNames ? '' : 'MOVED');
  ...
  static final $core.List<DeviceGroup_Type?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static DeviceGroup_Type? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const DeviceGroup_Type._(super.value, super.name);
}

class DeviceGroup_Role extends $pb.ProtobufEnum {
  static const DeviceGroup_Role FULL =
      DeviceGroup_Role._(0, _omitEnumNames ? '' : 'FULL');
  static const DeviceGroup_Role GVIEW =
      DeviceGroup_Role._(1, _omitEnumNames ? '' : 'GVIEW');
  static const DeviceGroup_Role GMANAGER =
      DeviceGroup_Role._(2, _omitEnumNames ? '' : 'GMANAGER');
  ...
  static final $core.List<DeviceGroup_Role?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static DeviceGroup_Role? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const DeviceGroup_Role._(super.value, super.name);
}

class InviteMessage_Role extends $pb.ProtobufEnum {
  static const InviteMessage_Role VIEW =
      InviteMessage_Role._(0, _omitEnumNames ? '' : 'VIEW');
  static const InviteMessage_Role ALL =
      InviteMessage_Role._(1, _omitEnumNames ? '' : 'ALL');
  ...
  static final $core.List<InviteMessage_Role?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 1);
  static InviteMessage_Role? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const InviteMessage_Role._(super.value, super.name);
}
...
class InviteMessage_GroupShareRole extends $pb.ProtobufEnum {
  ...
  static const $core.List<InviteMessage_GroupShareRole> values =
      <InviteMessage_GroupShareRole>[
    GFULL,
    GVIEW,
    GMANAGER,
  ];

  static final $core.List<InviteMessage_GroupShareRole?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static InviteMessage_GroupShareRole? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const InviteMessage_GroupShareRole._(super.value, super.name);
}
...
class InviteMessage_Status extends $pb.ProtobufEnum {
  ...
  static final $core.List<InviteMessage_Status?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static InviteMessage_Status? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const InviteMessage_Status._(super.value, super.name);
}
...
class InviteMessage_ShareType extends $pb.ProtobufEnum {
  ...
  static const $core.List<InviteMessage_ShareType> values =
      <InviteMessage_ShareType>[
    CAMERA,
    GROUP_CAMERA,
  ];

  static final $core.List<InviteMessage_ShareType?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 1);
  static InviteMessage_ShareType? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const InviteMessage_ShareType._(super.value, super.name);
}

class License_profile_ISON extends $pb.ProtobufEnum {
  static const License_profile_ISON OFF =
      License_profile_ISON._(0, _omitEnumNames ? '' : 'OFF');
  static const License_profile_ISON ON =
      License_profile_ISON._(1, _omitEnumNames ? '' : 'ON');
  ...
  static final $core.List<License_profile_ISON?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 1);
  static License_profile_ISON? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const License_profile_ISON._(super.value, super.name);
}

class User_Status extends $pb.ProtobufEnum {
  static const User_Status INACTIVE =
      User_Status._(0, _omitEnumNames ? '' : 'INACTIVE');
  static const User_Status ACTIVE =
      User_Status._(1, _omitEnumNames ? '' : 'ACTIVE');
  static const User_Status AGENT_CREATE =
      User_Status._(2, _omitEnumNames ? '' : 'AGENT_CREATE');
  ...
  static final $core.List<User_Status?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static User_Status? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const User_Status._(super.value, super.name);
}
...
class User_Type extends $pb.ProtobufEnum {
  ...
  static const User_Type SUPER_ADMIN =
      User_Type._(2, _omitEnumNames ? '' : 'SUPER_ADMIN');
  static const User_Type SYS_ADMIN =
      User_Type._(3, _omitEnumNames ? '' : 'SYS_ADMIN');
  static const User_Type AGENT = User_Type._(4, _omitEnumNames ? '' : 'AGENT');
  static const User_Type ADMIN_CLIENT =
      User_Type._(5, _omitEnumNames ? '' : 'ADMIN_CLIENT');
...
class NotificationMsg_MsgType extends $pb.ProtobufEnum {
  ...
  static const $core.List<NotificationMsg_MsgType> values =
      <NotificationMsg_MsgType>[
    GENERIC,
    SHARE,
  ];

  static final $core.List<NotificationMsg_MsgType?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 1);
  static NotificationMsg_MsgType? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const NotificationMsg_MsgType._(super.value, super.name);
}

class InOutCam_VehicleType extends $pb.ProtobufEnum {
  static const InOutCam_VehicleType CAR =
      InOutCam_VehicleType._(0, _omitEnumNames ? '' : 'CAR');
  static const InOutCam_VehicleType BIKE =
      InOutCam_VehicleType._(1, _omitEnumNames ? '' : 'BIKE');
  ...
  static final $core.List<InOutCam_VehicleType?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 1);
  static InOutCam_VehicleType? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const InOutCam_VehicleType._(super.value, super.name);
}

...
std::unordered_map<HWND, MediaKitVideoPlugin*> MediaKitVideoPlugin::instances_;
std::shared_mutex MediaKitVideoPlugin::instances_mutex_;
...
MediaKitVideoPlugin* MediaKitVideoPlugin::GetInstanceForWindow(HWND hwnd) {
  std::shared_lock<std::shared_mutex> lock(instances_mutex_);
...
LRESULT CALLBACK MediaKitVideoPlugin::WindowProcDelegate(HWND hwnd,
                                                         ...
                                                         WPARAM wParam,
                                                         LPARAM lParam) {
  MediaKitVideoPlugin* instance_ = GetInstanceForWindow(hwnd);

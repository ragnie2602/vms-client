...
class SubtitleView extends StatefulWidget {
  ...
  /// {@macro subtitle_view}
  const SubtitleView({super.key, required this.controller, required this.configuration});
...
class SubtitleViewState extends State<SubtitleView> {
  ...
  void setPadding(EdgeInsets padding, {Duration duration = const Duration(milliseconds: 100)}) {

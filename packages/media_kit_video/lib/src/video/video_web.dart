...
class VideoState extends State<Video> with WidgetsBindingObserver {
  ...
  void didUpdateWidget(Video oldWidget) {
    ...
    final newParams = currentParams.copyWith(
      ...
      focusNode:
          widget.focusNode != oldWidget.focusNode ? widget.focusNode : currentParams.focusNode,
    );
  ...
  void didChangeDependencies() {
    ...
    _disposeNotifiers =
        media_kit_video_controls.VideoStateInheritedWidget.maybeOf(context)?.disposeNotifiers ??
            true;
            ...
            child: Stack(
              ...
              children: [
                ...
                if (videoViewParameters.controls != null)
                  Positioned.fill(child: videoViewParameters.controls!.call(this as dynamic)),
              ],
            ),
          );
        },

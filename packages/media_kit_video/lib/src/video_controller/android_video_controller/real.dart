...
class AndroidVideoController extends PlatformVideoController {
  ...
  static Future<PlatformVideoController> create(
    ...
    await _channel.invokeMethod('VideoOutputManager.Create', {'handle': handle.toString()});
  ...
  Future<void> setSize({int? width, int? height}) {
    throw UnsupportedError('[AndroidVideoController.setSize] is not available on Android');
  }
  ...
  Future<void> _dispose() async {
    ...
    await _channel.invokeMethod('VideoOutputManager.Dispose', {'handle': handle.toString()});
  }

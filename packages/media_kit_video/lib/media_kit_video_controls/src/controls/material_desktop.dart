...
Widget MaterialDesktopVideoControls(VideoState state) {
  return const VideoControlsThemeDataInjector(child: _MaterialDesktopVideoControls());
}
...
class MaterialDesktopVideoControlsTheme extends InheritedWidget {
  ...
  static MaterialDesktopVideoControlsTheme of(BuildContext context) {
    ...
    assert(result != null, 'No [MaterialDesktopVideoControlsTheme] found in [context]');
    return result!;
  }
...
class MaterialDesktopPlayOrPauseButton extends StatefulWidget {
  ...
  const MaterialDesktopPlayOrPauseButton({super.key, this.iconSize, this.iconColor});
...
class MaterialDesktopSkipNextButton extends StatelessWidget {
  ...
  const MaterialDesktopSkipNextButton({super.key, this.icon, this.iconSize, this.iconColor});
...
class MaterialDesktopSkipPreviousButton extends StatelessWidget {
  ...
  const MaterialDesktopSkipPreviousButton({super.key, this.icon, this.iconSize, this.iconColor});
...
class MaterialDesktopFullscreenButton extends StatelessWidget {
  ...
  const MaterialDesktopFullscreenButton({super.key, this.icon, this.iconSize, this.iconColor});
              ...
              icon: AnimatedSwitcher(
                ...
                child: volume == 0.0
                    ? (widget.volumeMuteIcon ??
                        const Icon(Icons.volume_off, key: ValueKey(Icons.volume_off)))
                    : volume < 50.0
                        ? (widget.volumeLowIcon ??
                            const Icon(Icons.volume_down, key: ValueKey(Icons.volume_down)))
                        : (widget.volumeHighIcon ??
                            const Icon(Icons.volume_up, key: ValueKey(Icons.volume_up))),
              ),
            ),
            AnimatedOpacity(

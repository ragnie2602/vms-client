...
const kDefaultMaterialVideoControlsThemeDataFullscreen = MaterialVideoControlsThemeData(
  ...
  bottomButtonBar: [MaterialPositionIndicator(), Spacer(), MaterialFullscreenButton()],
...
class _MaterialVideoControlsState extends State<_MaterialVideoControls> {
  ...
  void onHorizontalDragEnd() {
    if (swipeDuration != 0) {
      ...
      newPosition = newPosition.clamp(Duration.zero, controller(context).player.state.duration);
              ...
              children: [
                ...
                AnimatedOpacity(
                  ...
                  child: Stack(
                    ...
                    alignment: Alignment.center,
                    children: [
                      Positioned.fill(child: Container(color: _theme(context).backdropColor)),
                      ...
                      Positioned.fill(
                        ...
                        child: Listener(
                          ...
                          child: GestureDetector(
                            ...
                            onLongPress:
                                _theme(context).speedUpOnLongPress ? _handleLongPress : null,
                            onLongPressEnd:
                              ...
                              if (position.dx <= widgetWidth(context) / 2) {
                                ...
                                if ((!mount && _theme(context).brightnessGesture) ||
                                  ...
                                  final brightness = _brightnessValue -
                                      delta / _theme(context).verticalGestureSensitivity;
                ...
                IgnorePointer(
                  child: AnimatedOpacity(
                    curve: Curves.easeInOut,
                    opacity: (!mount || _theme(context).gesturesEnabledWhileControlsVisible) &&
                            _volumeIndicator
                        ? 1.0
                        : 0.0,
                    duration: _theme(context).controlsTransitionDuration,
                ...
                IgnorePointer(
                  child: AnimatedOpacity(
                    ...
                    child: _theme(
                          context,
                        ).brightnessIndicatorBuilder?.call(context, _brightnessValue) ??
                        Container(
                          alignment: Alignment.center,
                          decoration: BoxDecoration(
                            color: const Color(0x88000000),
                      ...
                      child: Row(
                        children: [
                          ...
                          if (_theme(context).seekOnDoubleTapLayoutWidgetRatios[1] > 0)
                            Spacer(flex: _theme(context).seekOnDoubleTapLayoutWidgetRatios[1]),
                          Expanded(
...
class MaterialSeekBar extends StatefulWidget {
  ...
  const MaterialSeekBar({super.key, this.delta, this.onSeekStart, this.onSeekEnd});
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(_theme(context).seekBarThumbSize / 2),
                        ),
                      ),
                    ),
                  ],
...
class MaterialSkipNextButton extends StatelessWidget {
  ...
  const MaterialSkipNextButton({super.key, this.icon, this.iconSize, this.iconColor});
...
class MaterialSkipPreviousButton extends StatelessWidget {
  ...
  const MaterialSkipPreviousButton({super.key, this.icon, this.iconSize, this.iconColor});
...
class MaterialFullscreenButton extends StatelessWidget {
  ...
  const MaterialFullscreenButton({super.key, this.icon, this.iconSize, this.iconColor});
...
class MaterialPositionIndicatorState extends State<MaterialPositionIndicator> {
  ...
  Widget build(BuildContext context) {
    return Text(
      ...
      style: widget.style ??
          TextStyle(height: 1.0, fontSize: 12.0, color: _theme(context).buttonBarButtonColor),
    );
  }
}

...
class VideoControlsThemeDataInjector extends StatefulWidget {
  ...
  const VideoControlsThemeDataInjector({super.key, required this.child, this.context});
...
class _VideoControlsThemeDataInjectorState extends State<VideoControlsThemeDataInjector> {
  late final builders = <Widget Function(Widget)>[
    ...
    (child) {
      ...
      return MaterialVideoControlsTheme(normal: normal, fullscreen: fullscreen, child: child);
    },
    // MaterialDesktopVideoControlsTheme
    (child) {
  ...
  Widget build(BuildContext context) {
    return builders.fold<Widget>(widget.child, (child, builder) => builder(child));
  }
}
